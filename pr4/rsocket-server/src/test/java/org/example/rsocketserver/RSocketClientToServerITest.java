...
import org.example.rsocketserver.controllers.RSocketController;
import org.example.rsocketserver.data.Message;
...
public class RSocketClientToServerITest {
    ...
    public static void setupOnce(@Autowired RSocketRequester.Builder builder,
        ...
        requester = builder
                ...
                .rsocketStrategies(RSocketStrategies.Builder::encoder)
