...
public class Main {
    private static int MIN_TEMP_VALUE = 15;
    private static int MAX_TEMP_VALUE = 30;
    ...
    public static void main(String[] args) {
        Sensor sensorTemperature = new Sensor(MIN_TEMP_VALUE, MAX_TEMP_VALUE);
        ...
        observableCO2.join(
            ...
            public void onNext(@NonNull DataSensor dataSensor) {
                ...
                } else if (temperature > NORM_TEMP || co2 > NORM_CO2) {
